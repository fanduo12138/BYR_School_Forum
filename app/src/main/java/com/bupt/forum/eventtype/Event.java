package com.bupt.forum.eventtype;

import android.graphics.Bitmap;

import com.bupt.forum.metadata.Article;
import com.bupt.forum.metadata.Board;
...
public class Event
{
    ...
    public static class Search_ArticleList
    {
        private List<Article> search_list;
        public Search_ArticleList(List<Article> search_list)
        {
            this.search_list = search_list;
        }

        public List<Article> getSearch_list()
        {
            return search_list;
        }
    }
