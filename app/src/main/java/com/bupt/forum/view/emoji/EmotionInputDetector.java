package com.bupt.forum.view.emoji;
...
public class EmotionInputDetector
{
    ...
    public EmotionInputDetector bindToPlusButton(View plusButton)
    {
    ...
    public EmotionInputDetector setmPlusLayout(View mPlusLayout)
    {
        this.mPlusLayout = mPlusLayout;
        return this;
    }
    ...
    private void showEmotionLayout()
    {
        ...
        {
            softInputHeight = sp.getInt(SHARE_PREFERENCE_TAG, 600);
        }
        hideSoftInput();
